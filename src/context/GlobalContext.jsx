...
export const GlobalProvider = ({ children }) => {
    ...
    return (
        <GlobalContext.Provider value={{ titulo, darkMode, usuario, booklist, cartItems, setCartItems, inputsuggestion, suggestions, toggleDarkMode, changeTitulo, changeInputsuggestion }}>
            {children}
